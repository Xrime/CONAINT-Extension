...
export class JoinInspectorPanel {
    public static currentPanel: JoinInspectorPanel | undefined;
    public static readonly viewType = 'conaint.joinInspectorPanel';
    ...
    private constructor(panel: vscode.WebviewPanel, extensionUri: vscode.Uri, private manager: Manager) {
        this._panel = panel;
