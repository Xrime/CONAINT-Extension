...
export class SubmitProblemPanel {
    public static currentPanel: SubmitProblemPanel | undefined;
    public static readonly viewType = 'conaint.submitProblemPanel';
    ...
    private async submitProblem(data: any) {
        try {
            ...
            const problem = await this.manager.submitProblem(
                data.title,
                data.description,
            ...
            vscode.window.showErrorMessage('Failed to submit problem: ' + (error as Error).message);
        }
    }
