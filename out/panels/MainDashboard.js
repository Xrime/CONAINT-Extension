...
class MainDashboard {
    ...
    static create() {
        ...
        const panel = vscode.window.createWebviewPanel('mainDashboard', 'CONAINT Dashboard', vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    showJoinInspectorDialog() {
        this.panel.webview.postMessage({ command: 'showJoinDialog' });
    }
    joinInspectorSession(sessionId, displayName) {
