...
class MainDashboard {
    static currentPanel;
    static viewType = 'conaint.mainDashboard';
    _panel;
    _extensionUri;
    _disposables = [];
    manager;
    ...
    static createOrShow(extensionUri, manager) {
        ...
        const panel = vscode.window.createWebviewPanel(MainDashboard.viewType, 'CONAINT Dashboard', column || vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    async savePanelPreferences(preferences) {
