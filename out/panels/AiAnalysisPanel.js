...
class AiAnalysisPanel {
    ...
    static create() {
        ...
        const panel = vscode.window.createWebviewPanel('conaint-ai-analysis', 'CONAINT AI - Cheating Detection', vscode.ViewColumn.Two, {
            enableScripts: true,
    ...
    async analyzeSessionData(jsonData) {
        try {
            this.panel.webview.postMessage({
