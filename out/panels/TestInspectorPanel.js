...
class TestInspectorPanel {
    static currentPanel;
    static viewType = 'conaint.testInspectorPanel';
    _panel;
    _extensionUri;
    _disposables = [];
    manager;
    ...
    static createOrShow(extensionUri, manager) {
        ...
        const panel = vscode.window.createWebviewPanel(TestInspectorPanel.viewType, 'Test Inspector - CONAINT', column || vscode.ViewColumn.Two, {
            enableScripts: true,
