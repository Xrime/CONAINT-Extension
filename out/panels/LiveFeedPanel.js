...
class LiveFeedPanel {
    static currentPanel;
    static viewType = 'conaint.liveFeedPanel';
    _panel;
    _extensionUri;
    _disposables = [];
    manager;
    ...
    static createOrShow(extensionUri, manager) {
        ...
        const panel = vscode.window.createWebviewPanel(LiveFeedPanel.viewType, 'Live Feed - CONAINT', column || vscode.ViewColumn.Two, {
            enableScripts: true,
    ...
    async addSuggestion(problemId, content, userId) {
